...
df = df_list[0]		#select the first table data from the website
data_total = df.to_numpy()
data = data_total[:,[1,9,10]]

teamname, oeff, deff = data.T

for x, y, z in zip(oeff, deff, teamname):
...
ax.set_title('2019-2020 NBA Regular Season Power Ranking')
plt.show()
